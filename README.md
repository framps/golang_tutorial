...
16. genSitemap - Sample how to use go lightweight threading (goroutines). Actually it's the implementation of a website crawler which generates a sitemap.xml for a website. Used by the author for his websites.
